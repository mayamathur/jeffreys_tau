...
# convergence rates
#*note that boot-bca has frequent error of the form "estimated adjustment 'w' is infinite", so has poor convergence rates
# boot-perc has same low convergence rate as boot-bca because they're in the same tryCatch loop
...
# WINNER TABLES: BOOT SCENARIOS ONLY -------------------------
...
# *** All code below here is only run for main analyses:
...
} # end giant loop for sim_set == "main"
